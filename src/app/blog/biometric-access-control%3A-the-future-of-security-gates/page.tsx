// app/blog/biometric-access-control-future-of-security-gates/page.tsx
...
const bio = '/assets/Biometric.jpg'; // Update path if needed

const BiometricAccess = () => {
  return (
    <main className="min-h-screen px-4 py-10 mx-auto max-w-4xl">
      <Head>
        <title>Biometric Access Control: The Future of Security Gates | Synergy Access</title>
        <meta
          name="description"
          content="Explore how biometric access control systems are revolutionizing secure authentication through fingerprint, facial recognition, iris scanning, and other technologies."
        />
        <meta
          name="keywords"
          content="biometric access control, security gates, fingerprint scanner, facial recognition, iris scanning, secure authentication"
        />
      </Head>
      ...
      <article className="prose prose-lg max-w-none">
        <header className="mb-8">
          ...
          <h1 className="mb-3 text-3xl font-bold text-gray-900 md:text-4xl">
            Biometric Access Control: The Future of Security Gates
          </h1>
          <p className="mb-6 text-sm text-gray-500">Published on March 15, 2025 • 7 min read</p>
        ...
        <div className="mb-8 text-gray-700">
          <p className="mb-4 text-lg leading-relaxed">
            Biometric access control is transforming the security landscape by replacing traditional keys and cards with <strong>unique physiological identifiers</strong>. This technology offers unparalleled accuracy, enhanced security, and user convenience for a wide variety of applications—from corporate offices and government buildings to data centers and secure facilities.
          </p>
          <p className="mb-4">
            At <strong className="text-blue-800">Synergy Access</strong>, we provide state-of-the-art biometric solutions that combine <strong>military-grade encryption</strong> with intuitive interfaces, facilitating secure, fast, and reliable authentication methods such as fingerprint scanning, facial recognition, and iris scanning.
          </p>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              ...
              <tbody>
                ...
                ].map(([type, accuracy, speed, bestFor, failRate], index) => (
                  <tr key={index} className="border-b">
                    <td className="py-3 font-medium">{type}</td>
                    <td className="py-3">{accuracy}</td>
                    <td className="py-3">{speed}</td>
                    <td className="py-3">{bestFor}</td>
                    <td className="py-3">{failRate}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <section className="mb-8">
          ...
          <div className="grid gap-6 mb-6 md:grid-cols-2">
            {[
              ...
              <div
                key={index}
                className="flex p-4 transition-all duration-300 bg-white rounded-lg shadow-sm hover:shadow-md"
              >
        ...
        <section className="mb-8">
          ...
          <div className="p-4 text-center bg-blue-50 rounded-lg">
            <p className="mb-3 font-medium">Need biometric security for your facility?</p>
